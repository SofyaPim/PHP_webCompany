...
<div class="slider">
    <div class="item">
                <img src="/myProject1/images/top2.jpg" alt="Второй слайд">
                <div class="slideText">
                    <p class="moto">НОВЫЕ ТРЕННИНГИ, НОВЫЕ РАЗРАБОТКИ</p>
                    <p class="moto1"> GO TO TOP- новости</p>
        ...
        <div class="tema flexColumn">
            <?
                ...
                $result = mysqli_query($link, 'SELECT * FROM pages Where ID=2' );
